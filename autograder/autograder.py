...
def run_autograder():
    ...
    # Thoát với mã lỗi 1 nếu thiếu file hoặc test code bị lỗi
    if not all_files_exist or not all_code_passed:
        print("[WARNING] Co file bi thieu hoac kiem thu code khong dat. Vui loi kiem tra lai log.")
        sys.exit(1)
    else:
        print("[SUCCESS] Tat ca cac file deu day du va code da vuot qua kiem thu an toan!")
        sys.exit(0)
